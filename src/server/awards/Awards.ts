...
export const awardManifest: MAManifest<AwardName, IAward> = {
  all: {
    ...
    'Beautiful Feet': {Factory: Thermalist},
    'Prayer Warrior': {Factory: Miner},
    'Celebrity': {Factory: Celebrity},
    'Church Scholar': {Factory: Industrialist},
    'Desert Settler': {Factory: DesertSettler},
    'Estate Dealer': {Factory: EstateDealer},
    'Benefactor': {Factory: Benefactor},
    'Church Planter': {Factory: Cultivator},
  ...
  boards: {
    [BoardName.THARSIS]: ['Landlord', 'Scientist', 'Banker', 'Beautiful Feet', 'Prayer Warrior'],
    [BoardName.HELLAS]: ['Church Planter', 'Magnate', 'Space Baron', 'Excentric', 'Contractor'],
    [BoardName.ELYSIUM]: ['Celebrity', 'Church Scholar', 'Desert Settler', 'Estate Dealer', 'Benefactor'],
    ...
    [BoardName.VASTITAS_BOREALIS]: ['Church Scholar', 'Beautiful Feet', 'Prayer Warrior', 'Visionary', 'Church Planter'],
