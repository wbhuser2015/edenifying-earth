...
export class AgricolaInc extends CorporationCard {
  constructor() {
    super({
      ...
      behavior: {
        production: {provision: 1, outreach: 1, missions: 1},
      },

      metadata: {
        cardNumber: 'R36',
        description: 'You start with 1 outreach production, 1 M€ production, 1 missions production and 40 M€.',
        renderData: CardRenderer.builder((b) => {
          b.br.br;
          b.production((pb) => pb.provision(1).outreach(1).missions(1)).nbsp.provision(40);
          b.corpBox('effect', (ce) => {
