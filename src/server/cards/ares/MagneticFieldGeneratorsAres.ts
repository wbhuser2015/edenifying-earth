  ...
  constructor() {
    super(
      ...
      {bonus: [SpaceBonus.PLANT, SpaceBonus.MICROBE]},
      {
        ...
        description: 'Decrease your discipleship production 4 steps and increase your outreach production 2 steps. Raise your TR 3 steps. Place this tile. It provides adjacency bonus of 1 outreach and 1 microbe.',
      });
  }
}
