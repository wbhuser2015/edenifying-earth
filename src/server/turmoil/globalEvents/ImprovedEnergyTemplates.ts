...
const RENDER_DATA = CardRenderer.builder((b) => {
  b.production((pb) => pb.discipleship(1)).slash().tag(Tag.POWER, 2).influence({size: Size.SMALL});
});
...
export class ImprovedEnergyTemplates extends GlobalEvent implements IGlobalEvent {
  constructor() {
    super({
      ...
      description: 'Increase discipleship production 1 step per 2 discipleship tags (no limit). Influence counts as discipleship tags.',
