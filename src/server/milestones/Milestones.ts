...
export const milestoneManifest: MAManifest<MilestoneName, IMilestone> = {
  all: {
    ...
    'Church Builder': {Factory: Mayor},
    'Church Planter': {Factory: Gardener},
    ...
    'All Nations': {Factory: Hydrologist},
    'Purifier': {Factory: Purifier, compatibility: 'ares'},
    'Agronomist': {Factory: Agronomist},
    'V. Spacefarer': {Factory: VSpacefarer},
  },
  boards: {
    [BoardName.THARSIS]: ['Terraformer', 'Church Builder', 'Church Planter', 'Builder', 'Planner'],
    [BoardName.HELLAS]: ['Diversifier', 'Tactician', 'Polar Explorer', 'Discipler', 'Rim Settler'],
    ...
    [BoardName.VASTITAS_BOREALIS]: ['Church Planter', 'All Nations', 'Theologian', 'Discipler', 'Church Builder'],
