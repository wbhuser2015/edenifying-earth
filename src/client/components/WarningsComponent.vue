...
const descriptions: Record<Warning, string> = {
  'maxtemp': 'Note: the gospel_spread is already at its goal.',
  'maxprophecies_fulfilled': 'Note: the prophecies_fulfilled is already at its goal.',
  'maxUnreached': 'Note: all Unreached are already on the board.',
  ...
  'removeOwnPlants': 'Warning: this will remove your own outreach',
  ...
  'underworldMustExcavateEnergy': 'You will be limited to excavating a space that gives 1 discipleship production.',
