export enum CardName {
  ...
  ASTEROID_MINING = 'Heavenly Provision',
  ...
  BIOMASS_COMBUSTORS = 'Burnt Offerings',
  BIRDS = 'Ravens of Elijah',
  BLACK_POLAR_DUST = 'Darkened Sun',
  ...
  COLONIZER_TRAINING_CAMP = 'Discipleship School',
  ...
  FLOODING = 'Days of Noah',
  FOOD_FACTORY = 'Joseph’s Granaries',
  FUEL_FACTORY = 'The Widow’s Oil',
  FUELED_GENERATORS = 'Holy Fire Generators',
  ...
  GIANT_SPACE_MIRROR = 'Bright & Morning Star',
  ...
  ICE_CAP_MELTING = 'End Times Unveiling',
  ...
  IMPORTED_GHG = 'Incense for Worship',
  ...
  INSULATION = 'Ark’s Waterproof Covering',
