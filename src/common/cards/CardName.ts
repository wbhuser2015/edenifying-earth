export enum CardName {
 ...
 // My new cards above ^ Updated cards below v:
  ...
  SACKCLOTH_AND_ASHES = 'New Language Translation',
  SEA_OF_GALILEE_HARVEST = 'Celebrity joins congregation',
...
KELP_FARMING = 'Sea of Galilee Harvest',
