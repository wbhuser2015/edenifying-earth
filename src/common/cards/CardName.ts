export enum CardName {
  ...
  FELLOWSHIP_OF_BELIEVERS = 'Fellowship of Believers',
  LOAVES_AND_FISHES = 'Loaves and Fishes',
  HARVEST_FESTIVAL = 'Harvest Festival',
  THE_WIDOWS_OIL = 'The Widows Oil',
  BLESSINGS_OF_OBEDIENCE = 'Blessings of Obedience',
  BUILDING_THE_TABERNACLE = 'Building the Tabernacle',
  RUTHS_REDEMPTION = 'Ruths Redemption',
  STOREHOUSES_OF_JOSEPH = 'Storehouses of Joseph',
  MANNA_FROM_HEAVEN = 'Manna from Heaven',
  ...
  SOLOMOIC_TEMPLE = 'Solomons Temple',
  ...
  MISSIONS_SUNDAY = 'Missions Sunday',
  DISCIPLESHIP_GROUPS = 'Discipleship Groups',
  GIVING_CAMPAIGN = 'Giving Campaign',
  DTS = 'Dallas Theological Seminary',
  PRAYER_MEETING = 'Prayer Meeting',
  
 // My new cards above ^ Updated cards below v:
  BUSHES = 'Street Evangelism', 
  BIOMASS_COMBUSTORS = 'Call out Church Scandal',  
  BLACK_POLAR_DUST = 'Establish missions org',
  LARGE_CONVOY = 'Outreach Revival',
  IMPORTED_GHG = 'Focus on Missions',   
  ICE_CAP_MELTING = 'Reach new people group',   
  GREENHOUSES = 'Series on Evangelism',   
  GIANT_SPACE_MIRROR = 'Discipleship Revival',   
  FOOD_FACTORY = 'Sowing & Reaping',   
  FLOODING = 'Flash missions',
  COLONIZER_TRAINING_CAMP = 'Return from Exile',
  PROTECTED_VALLEY = 'Church on the Beach',
  ROVER_CONSTRUCTION = 'Land Owner',
  DUST_SEALS = 'New Language Translation',
...
ADAPTED_LICHEN = 'Manna from Heaven',
ADVANCED_ALLOYS = 'Refined Gold',
ADVANCED_ECOSYSTEMS = 'Kingdom Flourishing',
AEROBRAKED_AMMONIA_ASTEROID = 'Heavenly Fire Descends',
AI_CENTRAL = 'Prophetic Insights',
AIR_RAID = 'Plagues of Egypt',
AIRLINERS = 'Pilgrimage Voyages',
ALGAE = 'Harvest of the Jordan',
ANTI_GRAVITY_TECHNOLOGY = 'Miraculous Ascension',
ANTS = 'Diligent Ants of Proverbs',
AQUIFER_PUMPING = 'Water from the Rock',
AQUIFER_TURBINES = 'Living Water Flow',
ARCHAEBACTERIA = 'Creation’s Foundation',
ARTIFICIAL_LAKE = 'Parted Waters',
...
BRIBED_COMMITTEE = 'Pharisaical Corruption',
BEAM_FROM_A_THORIUM_ASTEROID = 'Heavenly Firebeam',
BIG_ASTEROID = 'Sodom’s Destruction',
BIRDS = 'Ravens of Elijah',
BUILDING_INDUSTRIES = 'Nehemiah’s Builders',
BUSINESS_CONTACTS = 'Tentmaker Networks',
BUSINESS_NETWORK = 'The Widow’s Marketplace',
CALLISTO_PENAL_MINES = 'Prison of Paul & Silas',
CARBONATE_PROCESSING = 'Refiner’s Fire',
CAPITAL = 'The New Jerusalem',
CARETAKER_CONTRACT = 'Stewardship Mandate',
CARTEL = 'Temple Money Changers',
CEOS_FAVORITE_PROJECT = 'Parable of the Talents',
CLOUD_SEEDING = 'Elijah’s Prayer for Rain',
COMET = 'Star of Bethlehem',
COMMERCIAL_DISTRICT = 'Temple Courts',
COMMUNITY_SERVICES = 'Acts of Charity',
CONSCRIPTION = 'David’s Mighty Men',
CONVOY_FROM_EUROPA = 'Paul’s Missionary Journey',
CORONA_EXTRACTOR = 'Glory of the Lord',
CORPORATE_STRONGHOLD = 'Fortified Zion',
CRYO_SLEEP = 'Daniel’s Long Fast',
CUPOLA_CITY = 'Watchtower of the Prophets',
DECOMPOSERS = 'Ashes to Ashes',
DEEP_WELL_HEATING = 'Furnace of Affliction',
DEIMOS_DOWN = 'Hailstones of Judgment',
DESIGNED_MICROORGANISMS = 'Created for Good Works',
DEVELOPMENT_CENTER = 'Solomon’s Wisdom Hub',
DIRIGIBLES = 'Heavenly Chariots',
DOME_FARMING = 'Garden of Eden',
DOMED_CRATER = 'Gethsemane Sanctuary',
EARLY_SETTLEMENT = 'The Promised Land',
EARTH_CATAPULT = 'Elijah’s Fiery Chariot',
EARTH_ELEVATOR = 'Jacob’s Ladder',
EARTH_OFFICE = 'Council of Elders',
ECCENTRIC_SPONSOR = 'The Rich Young Ruler',
ECOLOGICAL_ZONE = 'Restored Creation',
ECOLOGY_EXPERTS = 'Adam’s Naming Task',
ECOLOGY_RESEARCH = 'Noah’s Ark Studies',
ELECTRO_CATAPULT = 'Thunder of Sinai',
ENERGY_SAVING = 'Wise Stewardship',
ENERGY_TAPPING = 'Samson’s Strength',
EOS_CHASMA_NATIONAL_PARK = 'Eden’s Wilderness',
EQUATORIAL_MAGNETIZER = 'Pillar of Fire',
EXTREME_COLD_FUNGUS = 'Frozen Wilderness Manna',
FARMING = 'Fields of Boaz',
FISH = 'Miraculous Catch',
FLOATER_LEASING = 'Loaves & Fishes Multiplication',
FLOATER_PROTOTYPES = 'Heavenly Manna Supply',
FLOATER_TECHNOLOGY = 'Walking on Water',
FUEL_FACTORY = 'The Widow’s Oil',
FUELED_GENERATORS = 'Build Classrooms',
FUSION_POWER = 'Holy Spirit’s Fire',
GALILEAN_WAYSTATION = 'Galilee Pilgrimage Stop',
GANYMEDE_COLONY = 'Missionary Outpost',
GENE_REPAIR = 'Restoration of the Blind',
GEOTHERMAL_POWER = 'The Fiery Furnace',
GHG_PRODUCING_BACTERIA = 'Pestilence of Egypt',
GHG_FACTORIES = 'Smoke of Judgment',
GIANT_ICE_ASTEROID = 'Pillar of Ice',
GRASS = 'Withering Grass of Isaiah',
GREAT_AQUIFER = 'The Wells of Isaac',
GREAT_DAM = 'The Red Sea Barrier',
GREAT_ESCARPMENT_CONSORTIUM = 'Tower of Babel Project',
GYROPOLIS = 'Chariots of Fire',
HACKERS = 'Pharisaic Deception',
HEATHER = 'Fields of Sharon',
HEAT_TRAPPERS = 'Sodom’s Furnace',
HEAVY_TAXATION = 'Roman Tribute',
HERBIVORES = 'Lambs of the Shepherd',
HIRED_RAIDERS = 'Babylonian Invaders',
HOUSE_PRINTING = 'Solomon’s Palace',
ICE_ASTEROID = 'Hailstorm Judgment',
ICE_MOON_COLONY = 'Antarctic Missionary Base',
IMMIGRANT_CITY = 'New Jerusalem’s Gates',
IMMIGRATION_SHUTTLES = 'Exodus Caravans',
IMPACTOR_SWARM = 'Wrath of the Lord',
IMPORTED_HYDROGEN = 'Water from the Heavens',
...
INTERSTELLAR_COLONY_SHIP = 'Paul’s Journeys Expanded',
INVENTION_CONTEST = 'Solomon’s Proverbs Contest',
INVENTORS_GUILD = 'Temple Artisans',
INVESTMENT_LOAN = 'Parable of the Shrewd Manager',
IO_MINING_INDUSTRIES = 'King Solomon’s Mines',
IRONWORKS = 'Armor of God Workshop',
JOVIAN_LANTERNS = 'The Star of Bethlehem',
JUPITER_FLOATING_STATION = 'Third Heaven Gateway',
LAGRANGE_OBSERVATORY = 'Watchmen on the Wall',
LAKE_MARINERIS = 'Sea of Glass',
LAND_CLAIM = 'Inheritance of the Saints',
LAVA_FLOWS = 'Lake of Fire',
LAVA_TUBE_SETTLEMENT = 'Underground Church',
LICHEN = 'Wilderness Manna Growth',
LIGHTNING_HARVEST = 'Thunder from Sinai',
LIVESTOCK = 'Job’s Blessed Herds',
  ...
  MINE = 'Mine',MIRANDA_RESORT = 'Miranda Resort',
  ...
  OCEAN_CITY = 'Unreached City',
  OCEAN_FARM = 'Unreached Farm',
  OCEAN_SANCTUARY = 'Unreached Sanctuary',
